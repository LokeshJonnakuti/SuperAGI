...
class GithubHelper:
    ...
    def sync_branch(self, repository_owner, repository_name, base_branch, head_branch, headers):
        ...
        response = requests.get(base_branch_url, headers=headers, timeout=60)
        ...
        response = requests.patch(head_branch_url, json=data, headers=headers, timeout=60)
        if response.status_code == 200:
            logger.info(
    ...
    def make_fork(self, repository_owner, repository_name, base_branch, headers):
        ...
        fork_response = requests.post(fork_url, headers=headers, timeout=60)
    ...
    def create_branch(self, repository_name, base_branch, head_branch, headers):
        ...
        branch_params = {
            ...
            'sha': requests.get(
                ...
                headers=headers, timeout=60).json()['object']['sha']
        }
        branch_response = requests.post(branch_url, json=branch_params, headers=headers, timeout=60)
    ...
    def delete_file(self, repository_name, file_name, folder_path, commit_message, head_branch, headers):
        ...
        file_response = requests.delete(file_url, json=file_params, headers=headers, timeout=60)
    ...
    def add_file(self, repository_owner, repository_name, file_name, folder_path, head_branch, base_branch, headers, commit_message, agent_id, agent_execution_id, session):
        ...
        file_response = requests.put(file_url, json=file_params, headers=headers, timeout=60)
    ...
    def create_pull_request(self, repository_owner, repository_name, head_branch, base_branch, headers):
        ...
        pr_response = requests.post(pull_request_url, json=pull_request_params, headers=headers, timeout=60)
    ...
    def get_pull_request_content(self, repository_owner, repository_name, pull_request_number):
        ...
        response = requests.get(pull_request_url, headers=headers, timeout=60)
    ...
    def add_line_comment_to_pull_request(self, repository_owner, repository_name, pull_request_number,
        ...
        response = requests.post(comments_url, headers=headers, json=data, timeout=60)
